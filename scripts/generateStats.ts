import digimons from "../src/data/digimons.json" with {type: 'json'}
import type { Digimon } from "../src/types/Digimon"
import fs from "fs"


//atualiza atributos de digimons.json
...
fs.writeFileSync("./src/data/digimons.json", JSON.stringify(digimonsWithStats, null, 2))
console.log("arquivo digimons.json atualizado com sucesso")
